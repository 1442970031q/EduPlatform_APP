var _vue = new Vue({
	...
	data: {
		...
		'obj': JSON.parse(APP.GLOBAL.queryString('item'))
	},
	methods: {
		'loadingPageData': function() {
			APP.GLOBAL.ajax({
				url: APP.CONFIG.BASE_URL + 'PersonIInspectedPersonalizedTasksList',
				data: this.form,
		...
		'gotoPalnDetail': function(item) {
			APP.GLOBAL.gotoNewWindow('check.student.paln.detail', {
				param: 'id=' + item.Id
			})
		}
	},
	created: function() {
		...
		this.form.studentId = this.obj.Id;
