...
(function (global, factory) {
    ...
    var dashboard$3 = {
        ...
        methods: {
            ...
            uploadToServer: function uploadToServer(file) {
                ...
                xhr.onload = function () {
                    if (xhr.status !== 200) {
                        config.errorUploadHandler(xhr.status);
    ...
    var i18nZhCn = {
        ...
        undo: '撤消',
        'line height': '行高',
        'exceed size limit': '图片最大为5MB，请重新选择'
    };
